...
public:
        ...
        blue(blue_)
    {
        ...
        /// 可以执行任何启动（为了使）对象进入可用状态，而不用担心任何事件在你准备好之前激发
        enable_events();
    }
...
private:
    ...
    ) const
    {
        ...
        /// 获取重叠区域
        /// 在这里做·获取重叠区域·，而不在draw()调用前，是因为有时候我们刻意想在这里做
...
//  ----------------------------------------------------------------------------
///drawable_window看起来不需要enable_events/disable_events
